    ...
    <footer className="bg-[#0a0a0a] text-gray-400">
      <div className="mx-auto w-full max-w-[1260px] px-4 py-10 sm:px-6 lg:px-10">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Image src="/visa.svg" alt="Visa" width={48} height={32} className="h-7 w-auto opacity-60" />
          <Image src="/mastercard.webp" alt="Mastercard" width={48} height={32} className="h-7 w-auto opacity-60" />
          <Image src="/paypal.png" alt="PayPal" width={48} height={32} className="h-7 w-auto opacity-60" />
          <Image src="/apple-pay.svg" alt="Apple Pay" width={48} height={32} className="h-7 w-auto opacity-60" />
          <Image src="/google_pay.png" alt="Google Pay" width={48} height={32} className="h-7 w-auto opacity-60" />
        </div>
